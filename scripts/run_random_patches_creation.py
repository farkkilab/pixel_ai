...
patch_size = (128, 128)
output_path = '/data/projects/pixel_project/datasets/NKI_project_TMAs/patches/randomly_generated/'
...
if __name__ == "__main__":
    ...
    for slide in slides_directories:
        files_to_process = [file for file in glob.glob("/data/projects/pixel_project/datasets/NKI_project_TMAs/"+slide+"/Channels_all/*.tif")]
        output_path_core = output_path+slide+"/"
