...
from models.embed_subtype_classifier_1channel import EmbedSubtypeClassifier1Channel
...
def main():
    ...
    if model == 'vit':
        ...
        batch_size = 128
        classifier_model = EmbedSubtypeClassifier1Channel(input_dim=input_dimensions, output_dim=1)
    ...
    tensor_dataset_train = TensorDataset(files=files_train,transform=transforms_train,labels=labels_train)
    tensor_dataset_test = TensorDataset(files=files_test,transform=transforms_test, labels=labels_test)
