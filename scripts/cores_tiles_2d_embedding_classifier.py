...
def main():
    ...
    tensor_dataset_train = TensorDataset2D(slides=cores_train,transform=transforms_train,labels=labels_train)
    tensor_dataset_test = TensorDataset2D(slides=cores_test,transform=transforms_test, labels=labels_test)
