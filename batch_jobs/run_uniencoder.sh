...
export HUGGING_FACE_HUB_TOKEN=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
export OMP_NUM_THREADS=$SLURM_CPUS_PER_TASK
module load pytorch/2.3

source venv/bin/activate
srun python scripts/uni_encoder.py --files_path /scratch/project_2003009/NKI_histoprep_patches/224 --tiles_embedding_path /scratch/project_2003009/histoprep_embeddings_uni/224 --image_normalization true
