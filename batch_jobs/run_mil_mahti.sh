...
srun python scripts/cores_tiles_mil_classifier.py --files_path /scratch/project_2003009/histoprep_embeddings_uni/224/0_25_28 --filter_cores_lowcancer true --model_encoder uni --image_normalization false
