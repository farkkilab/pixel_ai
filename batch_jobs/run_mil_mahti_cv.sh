...
srun python scripts/cores_tiles_mil_classifier_cv.py --files_path /scratch/project_2003009/gigapath_tiles_embeddings/224/0_25_28 --filter_cores_lowcancer false --model_encoder gigapath --image_normalization false
